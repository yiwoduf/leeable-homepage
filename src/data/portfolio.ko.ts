...
export const portfolioKo: PortfolioData = {
  ...
  about: {
    lead: '아이디어를 컨셉부터 출시된 제품까지 끝까지 직접 책임지고 만들어내는 빌더형 AI 프로덕트 엔지니어입니다. 정답이 없는 모호한 상황에서 오히려 강하며, 시스템 사고와 제품 감각을 AI 네이티브 워크플로우와 결합합니다.',
  ...
  experience: [
    {
      ...
      points: [
        ...
        'News HQ를 구축했습니다 — 4개 에이전트가 협업하는 자체 호스팅 뉴스 인텔리전스 시스템으로, 10개 이상의 소스에서 매일 약 500건의 기사를 수집·중복 제거·분석·보고해 벡터 지식베이스에 적재하고, RAG 챗으로 질의까지 가능합니다. 매일 무인으로 돌아갑니다.',
      ],
